...
class RangeSliderUI extends BasicSliderUI {
     ...
     */
    protected void setColors(Color rangeColor, Color lowerThumbColor, Color upperThumbColor) {
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(this.lowerThumbColor);
        g2d.fill(thumbShape);
    ...
    private void paintUpperThumb(Graphics g) {
        ...
        g2d.setColor(this.upperThumbColor);
        g2d.fill(thumbShape);
