...
public class TouchSlider extends Region {
    ...
    public TouchSlider() {
        ...
        barBackbroundFilled = new StyleableBooleanProperty(true) {
            ...
            @Override
            public String getName() {
                return "barBackgroundFilled";
            }

            @Override
            public CssMetaData<? extends Styleable, Boolean> getCssMetaData() {
                return BAR_BACKGROUND_FILLED;
            }
        };
        ...
        value = new DoublePropertyBase(0) {
            @Override
            protected void invalidated() {
                if (Double.compare(get(), oldValue) == 0) {
                    return;
                }
                redraw();
    ...
    private void registerListeners() {
        ...
        //This is what should happen in the ideal world where Windows machines with touchscreens report the capability, as it doesn't, we always add all the listeners
...
//        }
    ...
    public double getMinValue() {
        return minValue.getValue().doubleValue();
    }
    ...
    public ObservableValue minValueProperty() {
        return minValue;
    }
    ...
    public boolean getReturnToZero() {
        return returnToZero.get();
    }

    public void setReturnToZero(final boolean returnToZero) {
        this.returnToZero.set(returnToZero);
    }
    ...
    public double getSliderValue() {
        return (getMinValue() + getRange() * getValue());
    }
    ...
    public Color getBarBackgroundColor() {
        return barBackgroundColor.getValue();
    }
    ...
    public void setBarBackgroundColor(final Color color) {
        barBackgroundColor.setValue(color);
    }

    public StyleableObjectProperty<Color> barBackgroundColorProperty() {
        return barBackgroundColor;
    }
    ...
    public void setBarColor(final Color color) {
        barColor.setValue(color);
    }

    public StyleableObjectProperty<Color> barColorProperty() {
        return barColor;
    }
    ...
    public void setThumbColor(final Color color) {
        thumbColor.setValue(color);
    }

    public StyleableObjectProperty<Color> thumbColorProperty() {
        return thumbColor;
    }
    ...
    public Color getValueTextColor() {
        return valueTextColor.getValue();
    }
     ...
     * @param color
     */
    public void setValueTextColor(final Color color) {
        valueTextColor.setValue(color);
    }

    public StyleableObjectProperty<Color> valueTextColorProperty() {
        return valueTextColor;
    }

    public Color getNameTextColor() {
        return nameTextColor.getValue();
    }

    public void setNameTextColor(final Color color) {
        nameTextColor.setValue(color);
    }

    public StyleableObjectProperty<Color> nameTextColorProperty() {
        return nameTextColor;
    }

    public Color getZeroColor() {
        return zeroColor.getValue();
    }

    public void setZeroColor(final Color color) {
        zeroColor.setValue(color);
    }

    public StyleableObjectProperty<Color> zeroColorProperty() {
        return zeroColor;
    }
    ...
    public StyleableStringProperty nameProperty() {
        return name;
    }
    ...
    public boolean isValueVisible() {
        return valueVisible.getValue();
    }

    public void setValueVisible(final boolean visible) {
        valueVisible.setValue(visible);
    }

    public StyleableBooleanProperty valueVisibleProperty() {
        return valueVisible;
    }

    public boolean isNameVisible() {
        return nameVisible.getValue();
    }

    public void setNameVisible(final boolean visible) {
        nameVisible.setValue(visible);
    }

    public StyleableBooleanProperty nameVisibleProperty() {
        return nameVisible;
    }

    public String getFormatString() {
        return formatString.getValue();
    }

    public void setFormatString(final String formatString) {
        this.formatString.setValue(formatString);
    }

    public StyleableStringProperty formatStringProperty() {
        return formatString;
    }

    public boolean getFilledBarBackground() {
        return barBackbroundFilled.getValue();
    }

    public void setBarBackbroundFilled(final boolean filled) {
        barBackbroundFilled.setValue(filled);
    }

    public StyleableBooleanProperty filledBarBackgroundProperty() {
        return barBackbroundFilled;
    }

    public boolean getShowZero() {
        return showZero.getValue();
    }

    public void setShowZero(final boolean show) {
        showZero.setValue(show);
    }

    public StyleableBooleanProperty showZeroProperty() {
        return showZero;
    }

    public boolean getStartFromZero() {
        return startFromZero.getValue();
    }

    public void setStartFromZero(final boolean start) {
        startFromZero.setValue(start);
    }

    public StyleableBooleanProperty startFromZeroProperty() {
        return startFromZero;
    }

    public boolean getSnapToZero() {
        return snapToZero.getValue();
    }

    public void setSnapToZero(final boolean snap) {
        snapToZero.setValue(snap);
    }

    public StyleableBooleanProperty snapToZeroProperty() {
        return snapToZero;
    }
    ...
    // ******************** Event Handling ************************************
    public void addTouchSliderObserver(final TouchSliderObserver observer) {
        if (!observers.contains(observer)) {
            observers.add(observer);
        }
    }

    public void removeTouchSliderObserver(final TouchSliderObserver observer) {
        if (observers.contains(observer)) {
            observers.remove(observer);
        }
    }

    public void fireTouchSliderEvent(final TouchSliderEvent evt) {
        observers.forEach(observer -> observer.onTouchSliderEvent(evt));
    }
    ...
    public String getUserAgentStylesheet() {
        if (null == userAgentStyleSheet) {
            userAgentStyleSheet = TouchSlider.class.getResource(CSS_FILE).toExternalForm();
        }
